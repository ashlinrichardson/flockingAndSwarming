...
function retval = runme_single_03(n)
%======================================================================
%PARAMETERS
%======================================================================
    par.d_cutoff   = 1; %default 50 %0.5;%0.7; %0.01;%10; %0.01
    par.e_cutoff   = 2;%par.d_cutoff/10.; %0.5;%0.7; %0.01;%10; %0.01
    
    par.R_coeff    = 15.;%1.;% 50;%1.;%1; %10 %0.2   % default 1
    par.S_coeff    = 6;%5.;% 50;   %default 100 
    par.angle_cut1 = 1.57;  % 80deg
    par.angle_cut2 = 1.047; % 60deg    %CHECK NOTATION.... 
    par.alpha      = 0.5;
    par.T_coeff    = 0.005;%05;% 0.0001;%0.001;%50;%0.05;  
    par.fric_alpha = 1;
    par.fric_beta  = 1;
...
% Each column (x,xdot,y,ydot,z,zdot) represents one bird.
    ...
    c2 = c2/2;
    A(1,:)=A(1,:)*c1; A(3,:)=A(3,:)*c1; A(5,:)=A(5,:)*(c1)/5.;
