...
function retval = runme_turning_force_only(n)
%======================================================================
%PARAMETERS
%======================================================================
    ...
    par.alpha      = 0.5;
    par.T_coeff    = 0.;%50;%0.05;  %default 0.05 set to 1 for overcurly.
   % par.C_coeff    = 1000;
    par.fric_alpha = 1;
    par.fric_beta  = 1;
    par.B_delta  = 100;%par.d_cutoff/0.5;%1/20;    
    par.B_epsilon  = 50;%par.d_cutoff/0.5;%1/20;
%======================================================================
%INITIAL DATA
%======================================================================
