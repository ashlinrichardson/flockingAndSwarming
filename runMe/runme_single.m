...
function retval = runme_single(n)
%======================================================================
%PARAMETERS
%======================================================================
    ...
    par.S_coeff    = 1;%5.;% 50;   %default 100 
    par.angle_cut1 = 1.57*0.6;  % 80deg
    par.angle_cut2 = 1.047*0.6; % 60deg    %CHECK NOTATION.... 
    par.alpha      = 0.5;
    par.T_coeff    =0.01;%05;% 0.0001;%0.001;%50;%0.05; 
    par.fric_alpha = 1;
    par.fric_beta  = 1;
    
    par.v_cutoff   = 1;%0.99*sqrt(par.fric_alpha/par.fric_beta);%0.5; % 2
    par.ve_cutoff  = 1;%par.v_cutoff/12.;
...
% Each column (x,xdot,y,ydot,z,zdot) represents one bird.
    ...
    c2 = c2/2;
    A(1,:)=A(1,:)*c1; A(3,:)=A(3,:)*c1; A(5,:)=A(5,:)*(c1);
...
%======================================================================
    ...
    %n=n*2;
    T = 2000;
    save runme_single_last_data.mat;
