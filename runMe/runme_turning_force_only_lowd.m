...
function retval = runme_turning_force_only_lowd(n)
%======================================================================
%PARAMETERS
%======================================================================
    ...
    par.S_coeff    = 0.;% 50;   %default 100 
    par.angle_cut1 = 1.57;  % 80deg
    par.angle_cut2 = 1.047; % 60deg    %CHECK NOTATION.... 
    par.alpha      = 0.5;
    par.T_coeff    = 1;%50;%0.05;  %default 0.05 set to 1 for overcurly.
    par.fric_alpha = 1;
    par.fric_beta  = 1;
    par.B_delta  = 0.01;%par.d_cutoff/0.5;%1/20;    
    par.B_epsilon  = 0.01;%par.d_cutoff/0.5;%1/20;
%======================================================================
%INITIAL DATA
%======================================================================
...
% Each column (x,xdot,y,ydot,z,zdot) represents one bird.
    ...
    B(2,:)=B(2,:)*c2; B(4,:)=B(4,:)*c2; B(6,:)=B(6,:)*(c2/5.);
    retval =0;
